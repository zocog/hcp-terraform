...
var file_tfplugin5_proto_depIdxs = []int32{
	...
	4,   // 98: tfplugin5.RenewEphemeralResource.Request.state:type_name -> tfplugin5.DynamicValue
	...
	4,   // 101: tfplugin5.CloseEphemeralResource.Request.state:type_name -> tfplugin5.DynamicValue
	5,   // 102: tfplugin5.CloseEphemeralResource.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	97,  // 103: tfplugin5.GetFunctions.Response.functions:type_name -> tfplugin5.GetFunctions.Response.FunctionsEntry
	5,   // 104: tfplugin5.GetFunctions.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	13,  // 105: tfplugin5.GetFunctions.Response.FunctionsEntry.value:type_name -> tfplugin5.Function
	...
	68,  // 115: tfplugin5.Provider.Configure:input_type -> tfplugin5.Configure.Request
	70,  // 116: tfplugin5.Provider.ReadResource:input_type -> tfplugin5.ReadResource.Request
	72,  // 117: tfplugin5.Provider.PlanResourceChange:input_type -> tfplugin5.PlanResourceChange.Request
	74,  // 118: tfplugin5.Provider.ApplyResourceChange:input_type -> tfplugin5.ApplyResourceChange.Request
	76,  // 119: tfplugin5.Provider.ImportResourceState:input_type -> tfplugin5.ImportResourceState.Request
	79,  // 120: tfplugin5.Provider.MoveResourceState:input_type -> tfplugin5.MoveResourceState.Request
	81,  // 121: tfplugin5.Provider.ReadDataSource:input_type -> tfplugin5.ReadDataSource.Request
	66,  // 122: tfplugin5.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin5.ValidateEphemeralResourceConfig.Request
	89,  // 123: tfplugin5.Provider.OpenEphemeralResource:input_type -> tfplugin5.OpenEphemeralResource.Request
	91,  // 124: tfplugin5.Provider.RenewEphemeralResource:input_type -> tfplugin5.RenewEphemeralResource.Request
	93,  // 125: tfplugin5.Provider.CloseEphemeralResource:input_type -> tfplugin5.CloseEphemeralResource.Request
	95,  // 126: tfplugin5.Provider.GetFunctions:input_type -> tfplugin5.GetFunctions.Request
	98,  // 127: tfplugin5.Provider.CallFunction:input_type -> tfplugin5.CallFunction.Request
	38,  // 128: tfplugin5.Provider.Stop:input_type -> tfplugin5.Stop.Request
	83,  // 129: tfplugin5.Provisioner.GetSchema:input_type -> tfplugin5.GetProvisionerSchema.Request
	85,  // 130: tfplugin5.Provisioner.ValidateProvisionerConfig:input_type -> tfplugin5.ValidateProvisionerConfig.Request
	87,  // 131: tfplugin5.Provisioner.ProvisionResource:input_type -> tfplugin5.ProvisionResource.Request
	...
	69,  // 139: tfplugin5.Provider.Configure:output_type -> tfplugin5.Configure.Response
	71,  // 140: tfplugin5.Provider.ReadResource:output_type -> tfplugin5.ReadResource.Response
	73,  // 141: tfplugin5.Provider.PlanResourceChange:output_type -> tfplugin5.PlanResourceChange.Response
	75,  // 142: tfplugin5.Provider.ApplyResourceChange:output_type -> tfplugin5.ApplyResourceChange.Response
	78,  // 143: tfplugin5.Provider.ImportResourceState:output_type -> tfplugin5.ImportResourceState.Response
	80,  // 144: tfplugin5.Provider.MoveResourceState:output_type -> tfplugin5.MoveResourceState.Response
	82,  // 145: tfplugin5.Provider.ReadDataSource:output_type -> tfplugin5.ReadDataSource.Response
	67,  // 146: tfplugin5.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin5.ValidateEphemeralResourceConfig.Response
	90,  // 147: tfplugin5.Provider.OpenEphemeralResource:output_type -> tfplugin5.OpenEphemeralResource.Response
	92,  // 148: tfplugin5.Provider.RenewEphemeralResource:output_type -> tfplugin5.RenewEphemeralResource.Response
	94,  // 149: tfplugin5.Provider.CloseEphemeralResource:output_type -> tfplugin5.CloseEphemeralResource.Response
	96,  // 150: tfplugin5.Provider.GetFunctions:output_type -> tfplugin5.GetFunctions.Response
	99,  // 151: tfplugin5.Provider.CallFunction:output_type -> tfplugin5.CallFunction.Response
	39,  // 152: tfplugin5.Provider.Stop:output_type -> tfplugin5.Stop.Response
	84,  // 153: tfplugin5.Provisioner.GetSchema:output_type -> tfplugin5.GetProvisionerSchema.Response
	86,  // 154: tfplugin5.Provisioner.ValidateProvisionerConfig:output_type -> tfplugin5.ValidateProvisionerConfig.Response
	88,  // 155: tfplugin5.Provisioner.ProvisionResource:output_type -> tfplugin5.ProvisionResource.Response
